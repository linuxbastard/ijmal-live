		...
		execute: (function () {
			...
			*/
			...
			var priceRange = container => {
			  ...
			  module.import('./nouislider-6399fa03.nomodule.js').then(function (n) { return n.n; }).then(_ref => {
			    var {
			      default: noUiSlider
			    } = _ref;
			...
			register('featured-collection', {
			  onLoad() {
			    ...
			    module.import('./index-6621b862.nomodule.js').then(function (n) { return n.i; }).then(_ref => {
			      var {
			        default: Flickity
			      } = _ref;
			...
			register('slideshow', {
			  ...
			  onLoad() {
			    ...
			    if (enableParallax === 'true') {
			      module.import('./simpleParallax.min-1eace759.nomodule.js').then(function (n) { return n.s; }).then(_ref2 => {
			        var {
			...
			register('video', {
			  onLoad() {
			    module.import('./fluorescent-video.es-d7dd6a6b.nomodule.js').then(_ref => {
			      var {
			        default: Video
			      } = _ref;
			...
			register('full-width-image', {
			  onLoad() {
			    ...
			    module.import('./simpleParallax.min-1eace759.nomodule.js').then(function (n) { return n.s; }).then(_ref => {
			      var {
			        default: simpleParallax
			      } = _ref;
			      this.parallaxElements = images.map(image => {
...
//# sourceMappingURL=theme-0d0328ed.nomodule.js.map
